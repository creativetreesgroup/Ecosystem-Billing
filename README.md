...
**Aktif dikembangkan.** Berjalan penuh di Docker dengan 591 test otomatis lulus.
...
| Identitas usaha dapat diubah dari panel — nama, logo, favicon | Verified | `SettingKey::BusinessName/BrandLogo/BrandFavicon`, 8 test |
...
**591 test lulus, 1.472 assertion** — Unit, Feature, dan Concurrency, terakhir
